  ...
  return (
    <div className="min-h-screen bg-background text-white p-4">
      ...
      <header className="flex justify-between items-center p-6">
        <div className="text-2xl font-bold text-accent">frij.io</div>
        <nav>
          <ul className="flex space-x-6 font-semibold font-sans text-secondary">
            <li
              className="cursor-pointer hover:underline hover:text-accent"
              onClick={() => router.push("/")}
            >
              Home
            </li>
      ...
      <main className="flex flex-col items-center justify-center px-6 py-12">
        <section className="text-center max-w-3xl">
          <h1 className="text-5xl font-bold mb-6 font-playpen text-accent">
            Welcome to frij.io
          </h1>
          <p className="text-xl mb-8 font-semibold font-sans text-secondary">
          ...
          <button
            ...
            className="border-2 border-accent px-6 py-2 rounded-full hover:bg-white hover:text-background transition font-semibold text-white"
          >
            Get Started
          </button>
        </section>
        ...
        <section className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center font-sans font-semibold">
          {/* Fridge Management */}
          <div className="p-6 bg-green rounded-3xl shadow-md text-white">
        ...
        {/* Team Section */}
        <section className="mt-16 text-center text-secondary">
